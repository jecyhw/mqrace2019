    ...
    public static void removeAll() {
        ...
        try {
            ...
            if (v != null && v != InternalThreadLocalMap.UNSET) {
                 ...
                 * toArray(new Object[0])效率高于toArray(new object[n]):https://shipilev.net/blog/2016/arrays-wisdom-ancients/#_conclusion
                 * There are two styles to convert a collection to an array: either using a pre-sized array (like c.toArray(new String[c.size()])) or using an empty array (like c.toArray(new String[0]).
                 * In older Java versions using pre-sized array was recommended, as the reflection call which is necessary to create an array of proper size was quite slow.
                 ...
                 * Also passing pre-sized array is dangerous for a concurrent or synchronized collection as a data race is possible between the size and toArray call which may result in extra nulls at the end of the array, if the collection was concurrently shrunk during the operation.
